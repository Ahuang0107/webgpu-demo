...
async fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let display_alpha = 231.0 / 255.0;
    let src_display_alpha: f64 = 1.0 - display_alpha;
    println!("显示出来的颜色的 alpha 是 {}", display_alpha);
    println!("说明叠加上去的颜色的 alpha 是 {}", src_display_alpha);
    println!("说明片元输出时的 alpha 是 {}", src_display_alpha.powf(2.2));
